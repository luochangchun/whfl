...
public interface AppStatic
{
	...
	public static final String WEB_APP_SESSION_USER_ID = "userid";
	/** WEB后台已登录变量名 */
	...
	public static final String WEB_APP_SESSION_USEROBJECT = "userObject";

	public static final String WEB_APP_SESSION_USER_BUTTION = "userbutton";

	public static final String WEB_APP_SESSION_USER_CATEGORY = "usercategory";
